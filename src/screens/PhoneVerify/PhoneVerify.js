...
const PhoneVerify = ({navigation}) => {
    ...
    return(
        <View style={{flex: 1, backgroundColor: colors.primary}}>
            ...
            <Text style={{fontSize: 15, padding: 1.5,}}>Register using your phone number</Text>
            </View>
            ...
            <TouchableOpacity style={{width: '100%',alignSelf: 'center',height: 50,justifyContent: 'center' ,alignItems: "center",backgroundColor: colors.primary,borderRadius: 50}} onPress={() => navigation.navigate('PhoneOTP')}>
